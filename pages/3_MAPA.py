...
locations = [
    ...
    {
        'name': 'Sede Limonal',
        'lat': 7.0083737725353465,
        'lon': -73.05149260633242,
        'description': 'OLT:SmartAX EA5800, DIO: BT72 de fukurawa Y ONTs:GPON XGS-PON HG8245A(donde se neseciten)'
    },
...
folium.Circle(
    ...
    radius=75,  # Radio del hexágono en metros
...
folium.Circle(
    ...
    fill_opacity=0.5,
    number_of_sides=6,  # Hexágono
    radius=165,  # Radio del hexágono en metros
...
folium.Circle(
    ...
    fill_opacity=0.5,
    number_of_sides=6,  # Hexágono
    radius=200,  # Radio del hexágono en metros
...
folium.Circle(
    ...
    fill_opacity=0.5,
    number_of_sides=6,  # Hexágono
    radius=120,  # Radio del hexágono en metros
